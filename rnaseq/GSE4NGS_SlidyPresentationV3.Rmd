...
- Next Generation Sequencing
    ...
    - counting these genes gives differentially expressed gene (DEG) lists for enrichment
...
- Select a param file for each step in your workflow. (trimming, alignment, counting DEGs)  
...
#### <big>To integrate several statistical enrichment tests </br> and functional annotation systems </br> into the systemPipeR NGS workflow environment </big>
</div>
</br>
...
## Slide 6 was combined with slide 5
...
## Visualization of the Enrichment Results (single genes)
...
## Visualization of the Enrichment Results (group of genes)
...
- This graph shows how many clusters of DEGs were assigned to each GO term. The graph was filtered to only show a single category.
